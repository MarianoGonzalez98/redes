...
Sólo se pueden producir colisiones en las partes de la red donde haya un hub. <!-- DUDA: OK?? -->
...
PC_C - PC_D - SWITCH1 es un dominio solo??


## b. ¿Cuántos dominios de broadcast hay?
1 <!-- Porque todos forman parte de la misma red? --> <!-- duda:ok?? -->
...
Hubieran escuchado las 2 consultas <!-- duda:ok?? -->
