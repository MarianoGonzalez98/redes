...
En base a la información brindada, se puede afirmar que es Pasiva, dado que es el cliente el que comienza el handshake para establecer la conexión con el servidor.
